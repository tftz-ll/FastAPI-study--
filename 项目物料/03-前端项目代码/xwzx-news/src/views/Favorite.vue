<template>
  <div class="favorite-container">
    ...
    <van-list
      v-model:loading="favoriteStore.loading"
      :finished="favoriteStore.finished"
      finished-text="没有更多了"
...
const onLoadFavorites = async () => {
  // loadMoreFavorites 自动判断首次加载还是翻页
  await favoriteStore.loadMoreFavorites();
};

// 组件挂载时重置分页，由 van-list 自动触发首次加载
onMounted(() => {
  favoriteStore.resetPagination();
});
</script>
